// app/admin/monitoring-enforcement/page.tsx
"use client"
...
import { Search, MapPin, Eye, CheckCircle, XCircle, AlertCircle } from "lucide-react"
...
export default function SubmissionsTable() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <Card>
        <CardHeader>
          <CardTitle>Monitoring & Enforcement Dashboard</CardTitle>
          <CardDescription>Manage site visits and document reviews</CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Conduct site visits using the Site Visit form. After completing the site visit, 
                      submit the report which will be sent to the Director.
                    </p>
                  </div>
                </CardContent>
              </Card>
                      ...
                      <TableRow key={submission.id}>
                        ...
                        <TableCell>
                          {submission.documents ? (
                            <Badge variant="default">Documents Uploaded</Badge>
                          ) : (
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <DialogFooter className="flex justify-between">
            ...
            <div className="flex gap-2">
              {selectedSubmission && activeTab === "documents" && (
                <>
                  <Button 
                    variant="destructive" 
                    onClick={() => handleAction("reject", "Documents Rejected")}
                  >
                  ...
                  <Button 
                    variant="default" 
                    onClick={() => handleAction("approve", "Documents Approved")}
                  >
